...
void fb_clear() { memset(frame_buffer, 0, sizeof(frame_buffer)); }

void fb_clear_draft() { memset(frame_buffer_draft, 0, sizeof(frame_buffer)); }
...
void fb_draw_wireframe(uint8_t x1, uint8_t y1, uint8_t z1, uint8_t x2,
                       uint8_t y2, uint8_t z2, rgb_t c) {
...
void fb_swap_pixels(uint8_t x1, uint8_t y1, uint8_t z1, uint8_t x2, uint8_t y2,
                    uint8_t z2) {
...
void line_3d_float(point_t point1, point_t point2, rgb_t color) {
  ...
  float i;
  float dx, dy, dz, l, m, n, x_inc, y_inc, z_inc, err_1, err_2, dx2, dy2, dz2;
  float pixel[3];
  pixel[0] = x1;
  pixel[1] = y1;
  pixel[2] = z1;
